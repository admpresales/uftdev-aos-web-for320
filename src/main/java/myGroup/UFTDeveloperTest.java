...
public class UFTDeveloperTest extends UnitTestClassBase {
    ...
    public void test() throws GeneralLeanFtException {
        ...
        EditField usernameEditField = browser.describe(EditField.class, new EditFieldDescription.Builder()
                ...
                .tagName("INPUT")
                .type("text").build());
        usernameEditField.setValue("rsercely");

        EditField passwordEditField = browser.describe(EditField.class, new EditFieldDescription.Builder()
                .name("password")
                .tagName("INPUT")
                .type("password").build());
        passwordEditField.setSecure("5f4d4b1a540f72ebe7a775d5c1695121e18620c2bf7f");
        ...
        /**
         ...
         Below is as recommended. Used the OIC to make the innerText a regular expression
         So that it will work even if number of items changes
         ...
         * And - ard to see, but to this regex uses multiple groupings (\d+)|,, to grab sets of digits ore a comma
         * and at he end, it gets .\d\d
         *
...
//            System.out.println(cartAmount);
        ...
        /**
         * Note - you generate the endrypted value from either
         * PasswordEncoder.exe
         * or
         * Password
         *
